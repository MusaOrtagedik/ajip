...
void ajip::on_btnSec_clicked()
{
    ...
    QString ver = query.at(1);
    QStringList ver1 = ver.split("u");
    klasorAdi = "jdk1." + ver1.at(0) + ".0_" + ver1.at(1);
...
{
    ui->txtCommandLine->insertPlainText("\n-------------------------------------------------------------------------------------------------------\n\n");
    ui->txtCommandLine->insertPlainText(QString::fromUtf8("ln -s /usr/lib/jvm/jdk1.8.0_141/jre/lib/amd64/libnpjp2.so /usr/lib/mozilla/plugins\n"));
    process->start("ln -s /usr/lib/jvm/jdk1.8.0_141/jre/lib/amd64/libnpjp2.so /usr/lib/mozilla/plugins");
    process->waitForFinished();
    ui->txtCommandLine->insertPlainText("\n-------------------------------------------------------------------------------------------------------\n\n");
